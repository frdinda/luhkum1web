                    ...
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            <div class="text-center mb-3">
                                <img src="img/avatars/logo_fix.png" alt="Kemenkumham" class="img-fluid" width="75" height="75" />
                            </div>
                            <h1 class="h2">KONSULTASI HUKUM</h1>
                            <p class="lead">
                                Sistem Konsultasi Hukum Kantor Wilayah Kementerian Hukum dan HAM Sumatera Utara
                            </p>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <form class="ed_user mt-3" id="ed_user" action="<?= base_url('/proslogin'); ?>" method="post">
                                        <?= csrf_field(); ?>
                                        <div class="mb-3">
                                        ...
                                        <div class="text-center mt-3">
                                            <span>
                                                <a href="<?= base_url("/regis"); ?>">Belum Punya Akun? Regsitrasi Disini</a>
                                            </span>
                                        </div>
                                    </form>
                                </div>
