                ...
                <div class="card-body py-3 pt-0 mt-3">
                    <form class="acc mb-5" id="acc" action="<?= base_url('/acc/save'); ?>" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="keterangan-pimpinan" class="keterangan-pimpinan form-control" name="keterangan-pimpinan" id="keterangan-pimpinan" placeholder="" required><?= $dp['keterangan_pimpinan']; ?></textarea>
                        </div>
                        <div class="mb-4">
                            <!-- ttd -->
                            <div class="mb-4">
