...
<?= $this->section('title'); ?>
<h1 class="navbar-align judul">EDIT DATA AKSES</h1>
<?= $this->endSection(); ?>
        ...
        <div class="card ps-3 pe-3">
            <div class="card-body">
                ...
                <form class="ed_user mt-3" id="ed_user" action="<?= base_url('/tanya/save_pertanyaan'); ?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="mb-4">
                        <input type="hidden" class="id_akses form-control" id="id_akses" placeholder="" required>
                        <label class="label-pertanyaan mb-2" for="id_akses">ID Akses<span class="bintang-label-pertanyaan">*</span></label>
                        <input type="text" class="id_akses form-control" id="id_akses" placeholder="" disabled>
                    </div>
                    <div class="mb-4">
